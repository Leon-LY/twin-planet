    ...
    <view class="timer-section" v-if="recordsStore.isRunning">
      ...
      <view class="dual-timers" v-else-if="recordsStore.runningTimers.length >= 2">
        <view
          ...
          :style="{ borderColor: getTimerBaby(timer.babyId)?.color || '#E2E8F0' }"
        >
          ...
          <button
            ...
            :style="{ background: getTimerBaby(timer.babyId)?.color || '#F56565' }"
...
.timer-hero {
  text-align: center; background: #FFFFFF; border-radius: 28rpx;
  padding: 48rpx 32rpx 32rpx; margin-bottom: 24rpx; border: 4rpx solid #48BB78;
}
...
.dual-timer-card {
  flex: 1; text-align: center; background: #FFFFFF; border-radius: 24rpx;
  padding: 32rpx 20rpx 24rpx; border: 4rpx solid #E2E8F0;
  display: flex; flex-direction: column; align-items: center; gap: 12rpx;
}
.dual-timer-baby { font-size: 26rpx; font-weight: 600; color: #2D3748; }
.dual-timer-label { font-size: 22rpx; color: #718096; }
.dual-timer-value { font-size: 56rpx; font-weight: 700; color: #2D3748; font-variant-numeric: tabular-nums; }
.btn-stop-small {
  width: 100%; padding: 16rpx 0; color: #FFFFFF; border: none;
  border-radius: 16rpx; font-size: 28rpx; font-weight: 600;
}
.btn-stop-all {
  width: 100%; padding: 24rpx 0; background: #ED8936; color: #FFFFFF;
...
.action-card {
  text-align: center; padding: 36rpx 12rpx; background: #FFFFFF;
...
.action-card.diaper { border-top: 8rpx solid #48BB78; }
