...
<style scoped>
.duty-page { min-height: 100vh; background: var(--twin-bg); padding: 32rpx 32rpx 120rpx; }
...
.baby-chip.blue { background: var(--twin-baby-a-light); color: var(--twin-baby-a); }
.baby-chip.pink { background: var(--twin-baby-b-light); color: var(--twin-baby-b); }
...
.btn-start, .btn-done { width: 100%; padding: 28rpx 0; background: var(--twin-baby-a); color: var(--twin-card-bg); border: none; border-radius: 24rpx; font-size: 36rpx; font-weight: 600; }
